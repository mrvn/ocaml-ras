...
(* OASIS_START *)
(* DO NOT EDIT (digest: a8b4bc6fe19136e2d9a18b8d10e4b4d3) *)
(*
...
let setup_t =
  {
     ...
     doc = [("ras", OCamlbuildDocPlugin.doc_build "lib")];
     ...
     clean_doc = [("ras", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test =
       [
          ("main",
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["field.h"; "field.c"; "ras_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                      ...
                      bs_cclib = [(OASISExpr.EBool true, ["-Wl,-z,relro"])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ras"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "Ô²r×\149\r^\134ï¼\157\138Y\146ðÕ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
